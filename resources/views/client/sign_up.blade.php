                            ...
                            <div class="app-top-items">
                                <a href="index.html">
                                    <div class="sign-logo" id="logo">
                                        ...
                                        <img class="logo-inverse" src="{{ asset('assets/images/dark-logo.svg') }}"
                                            alt="">
                                    </div>
                                </a>
                                <div class="app-top-right-link">
                                    Already have an account?<a class="sidebar-register-link"
                                        href="{{ url('/sign_in') }}">Sign In</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-5 col-lg-6 col-md-7">
                            <div class="registration">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            <div class="form-group mt-4">
                                                ...
                                                <input class="form-control h_50" name="email" type="email" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12">
                                            <div class="form-group mt-4">
                                                <label class="form-label">Phone</label>
                                                <input class="form-control h_50" name="phone" type="tel" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12">
                                ...
                                <div class="social-btns-list mb-lg-5">
                                    <button onclick="window.location='{{ url("auth/google") }}'" class="social-login-btn">
                                    ...
                                    <button class="social-login-btn">
                                        <svg class="me-2" xmlns="http://www.w3.org/2000/svg" width="24"
                                            height="24" viewBox="0 0 27 27">
                                            <g transform="translate(0)">
                                                <circle cx="13.5" cy="13.5" r="13.5"
                                                    transform="translate(0 0)" fill="#3b5998"></circle>
                                                <path
...
<!-- Mirrored from www.gambolthemes.net/html-items/barren-html/disable-demo-link/sign_up.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Mar 2024 22:52:56 GMT -->
